[assembly: WebActivator.PreApplicationStartMethod(typeof(WebApi.App_Start.NotificationService), "PreStart")]
...
namespace WebApi.App_Start
{
    ...
    using WebApi.CloudServices.Notifications.WindowsAzure;
