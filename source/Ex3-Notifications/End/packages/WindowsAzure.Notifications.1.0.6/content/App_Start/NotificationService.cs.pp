[assembly: WebActivator.PreApplicationStartMethod(typeof($rootnamespace$.App_Start.NotificationService), "PreStart")]
...
namespace $rootnamespace$.App_Start
{
    ...
    using $rootnamespace$.CloudServices.Notifications.WindowsAzure;
